...
### 3.1 Obtain the data for the venues network 
...
<span class="caption">_Figure 1: First five rows of next venues DataFrame_</span>
...
<span class="caption">_Figure 2: First five rows of venues information DataFrame_</span>
...
<span class="caption">_Figure 3: Folium map of Seattle showing next venue connections_</span>

![Folium Map Bridge from Fremont to Ballard \label{Figure 4}](images/folium_seattle_map_annotated.PNG)

<span class="caption">_Figure 4: Folium map of Seattle showing next-venue bridge from Fremon to Ballard_</span>

### 3.2 Create a Venues Network
...
<span class="caption">_Figure 5: Network DataFrame with edge weights_</span>
...
### 3.4 Characterizing Detected Communities
...
<span class="caption">_Figure 6: First five rows of venue DataFrame with top level categories_</span>
...
<span class="caption">_Figure 7: Next venue network visualized with pyvis_</span>
...
<span class="caption">_Figure 8: Next venue communities on map of Seattle_</span>
...
<span class="caption">_Figure 9: Community categorization by top level categories and average distances_</span>
...
<span class="caption">_Figure 10: Community categorization correlation heatmap_</span>
